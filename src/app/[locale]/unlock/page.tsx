...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/${locale}/unlock`, ...pageAlternates('/unlock') },
    openGraph: pageOpenGraph({ locale, path: `/${locale}/unlock`, title }),
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-md flex-1 px-6 py-10">
        ...
        <p className="mt-2 text-base text-[color:var(--muted-foreground)]">{t('body')}</p>

        <div className="mt-8">
          <UnlockForm locale={locale} />
        </div>
